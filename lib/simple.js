...
sendBut: {
        async value (jid, content, footerText, button1, id1, quoted, options) {
                ...
                conn.sendMessage(jid, buttonMessage, { quoted, ephemeralExpiration: 86400, contextInfo: { mentionedJid: conn.parseMention(content + footerText), forwardingScore: 0, isForwarded: false }, ...options })
            }
        },
